  ...
  <div class="admin-profiles-page">
    <section class="admin-header">
      <div class="container-fluid">
        <div class="d-flex flex-wrap justify-content-between align-items-center py-3 py-sm-4 gap-2 gap-sm-3">
          <h1 class="page-title mb-0 flex-shrink-0">Admin Profiles</h1>
          <div class="d-flex flex-wrap gap-2 gap-sm-3">
            <button class="btn btn-info btn-sm flex-grow-0" @click="openGlobalPermissionsModal">
              <i class="bi bi-shield-lock me-1 me-sm-2"></i>
              <span class="d-none d-sm-inline">Manage</span> Core
            </button>
            <button class="btn btn-primary btn-sm flex-grow-0" @click="openAddAdminModal">
              <i class="bi bi-plus-circle me-1 me-sm-2"></i>
              <span class="d-none d-sm-inline">Add</span> Admin
            </button>
          </div>
        </div>
      </div>
                ...
                <tbody>
                  ...
                  <tr v-for="admin in filteredAdmins" :key="admin.id">
                    ...
                    <td>
                      ...
                      <p class="text-muted small mb-0 d-none d-sm-block">{{ admin.username }}</p>
                      <!-- <p class="text-muted small mb-0">{{ admin.email }}</p> -->
                      <p class="text-muted small mb-0 d-none d-sm-block">{{ admin.email }}</p>
                    </td>
                    <td>
                      ...
                      <p class="text-muted small mb-0 truncate-address d-none d-sm-block">
                        {{ admin.address || 'Not provided' }}
                      </p>
                    </td>
                    <td>
                    ...
                    <td>
                      <div class="d-flex flex-wrap gap-2">
                        <button class="btn btn-sm btn-outline-primary text-nowrap" @click="openViewModal(admin)">
                          <i class="bi bi-eye"></i>
                        </button>
                        <button class="btn btn-sm btn-outline-secondary text-nowrap" @click="openEditModal(admin)">
                          <i class="bi bi-pencil"></i>
                        </button>
                        <button class="btn btn-sm btn-outline-info text-nowrap" @click="openPermissionsModal(admin)">
                          <i class="bi bi-shield-lock"></i> Permissions
                        </button>
                        <button class="btn btn-sm btn-outline-danger text-nowrap" @click="confirmDeleteAdmin(admin)">
                          <i class="bi bi-trash"></i>
                        </button>
                      </div>
                    </td>
